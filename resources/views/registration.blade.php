                    ...
                    <div class="card shadow text-white bg-beguni card-body">
                        <form action="{{route('registration-form')}}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input id="firstNumber" type="number" value="" name="start_number" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="endNumber" class="col-md-3">Ending Number</label>
                                <div class="col-md-9">
                                    <input id="endNumber" type="number" value="" name="end_number" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <textarea id="result" class="form-control" cols="30" rows="5"></textarea>
                                </div>
                            </div>
